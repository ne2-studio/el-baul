...
/// `dotnet ElBaul.Maintenance.dll &lt;name&gt;`. <see cref="MaintenanceCommandRunner"/> discovers
/// every attributed command via reflection — no separate registration list to keep in sync.
/// </summary>

...
describe('PushNotificationsHandler', () => {
  ...
  it('navigates to the deep link when a notification action is performed', async () => {
    ...
    await waitFor(() => expect(screen.getByTestId('location')).toHaveTextContent('/baules/abc'));
  });

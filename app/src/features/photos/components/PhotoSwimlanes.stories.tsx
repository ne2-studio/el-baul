...
const photos: Photo[] = [
  { id: '1', thumbnailUrl: 'https://images.unsplash.com/photo-1502685104226-ee32379fefbe?w=300', fullUrl: '', date: { year: 2024, month: 7, day: 15 } },
  { id: '2', thumbnailUrl: 'https://images.unsplash.com/photo-1503023345310-bd7c1de61c7d?w=300', fullUrl: '', date: { year: 2024, month: 7, day: 20 } },
  { id: '3', thumbnailUrl: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?w=300', fullUrl: '', date: { year: 2024, month: 12 } },
  { id: '4', thumbnailUrl: 'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?w=300', fullUrl: '', date: { year: 2023 } },
  { id: '5', thumbnailUrl: 'https://images.unsplash.com/photo-1470252649378-9c29740c9fa8?w=300', fullUrl: '' },
];

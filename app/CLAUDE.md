...
Read `../docs/architecture/native-android.md` and `../docs/architecture/native-ios.md` before
changing `android/`, `ios/`, Capacitor plugins, deep links, or native sharing.
